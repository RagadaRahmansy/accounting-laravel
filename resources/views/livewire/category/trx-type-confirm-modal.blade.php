    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Apakah anda yakin akan menghapus kategori {{$name}} <span style="font-weight: 600"></span>
            </div>
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-default bg-danger" data-dismiss="modal" wire:click="delete({{$type_id}})">
                    Hapus 
                </button>
            </div>
        </div>
