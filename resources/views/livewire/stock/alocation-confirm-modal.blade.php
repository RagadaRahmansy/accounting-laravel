    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Apakah anda yakin akan menghapus data alokasi ini? <span style="font-weight: 600"></span>
            </div>
            <div class="modal-footer">
                <x-adminlte-button label="Batal" theme="primary" wire:click="$set('show', 'hidden')"/>
                <button type="button" class="btn btn-default bg-danger" data-dismiss="modal" wire:click="delete({{$alocation_id}})">
                    Hapus 
                </button>
            </div>
        </div>
